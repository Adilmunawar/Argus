...
This directory is the *template* of the private `ZaraatDost/zd-cloud-gitops` repository (ADR-0021/0023). Its `main` branch is production. Only the reconciler writes to systems; humans write here.
